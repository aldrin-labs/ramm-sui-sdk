...
const getKeypair = function (): Secp256k1Keypair {
    ...
    const secret_key = Uint8Array.from(atob(privateKey), (c) => c.charCodeAt(0))
...
export const rammMiscFaucet: RAMMMiscFaucet = {
    packageId:
        "937e867b32da5c423e615d03d9f5e898fdf08d8f94d8b0d97805d5c3f06e0a1b",
    faucetModule: "test_coin_faucet",
    testCoinsModule: "test_coins",

    faucetAddress:
        "0x61fc830d05a3f0f7fee6d601cd88023fe5d39d52dc8028e8530bf60f46d8f784",
}
